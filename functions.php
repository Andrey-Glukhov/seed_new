...
function seed_scripts() {
	...
	wp_enqueue_style( 'seed-style', get_template_directory_uri() . '/css/tn_css.css' );


	wp_enqueue_script( 'seed-javascript', get_template_directory_uri() . '/js/seed.js', array( 'jquery' ), '20210606', true );
